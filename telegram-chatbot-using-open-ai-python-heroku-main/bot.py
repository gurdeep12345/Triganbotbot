...
#    TOKEN = str(f.read())
TOKEN = '5508470161:AAEepld7q8QbvymmVIl_YKOEnVJAtqErXsY'
session = {}
...
def about(update, context):
    update.message.reply_text("""Trigan is not just a chatbot. It's so much more than that. It's an AI-enabled customer service solution that answers your questions, responds to your tweets, and helps you find the products you're looking for. TriganBot has the power to save you time, increase your sales, and make your customer service operation more efficient.
        """)


def contact(update, context):
    update.message.reply_text("Developer: You \n email: projectcloud225@gmail.com\n")
